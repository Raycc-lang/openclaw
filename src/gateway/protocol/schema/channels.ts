...
export const ChannelAccountSnapshotSchema = Type.Object(
  {
    ...
    queuedRuns: Type.Optional(Type.Integer({ minimum: 0 })),
    currentQueueKey: Type.Optional(Type.String()),
    currentMessageId: Type.Optional(Type.Union([Type.String(), Type.Integer(), Type.Null()])),
    lastQueueWaitMs: Type.Optional(Type.Integer({ minimum: 0 })),
